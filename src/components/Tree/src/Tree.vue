<script lang="tsx">
  ...
  export default defineComponent({
    ...
    setup(props, { attrs, slots, emit, expose }) {
        ...
        searchState.searchData = filter(
          ...
          (node) => {
            const result = filterFn
              ...
              : node[titleField].toLowerCase()?.includes(searchValue.toLowerCase()) ?? false;
      ...
      return () => {
        const { title, helpMessage, toolbar, search, checkable, toolbarCheckable } = props;
        ...
        return (
          <div class={[bem(), 'h-full', attrs.class]}>
            {showTitle && (
              <TreeHeader
                checkable={checkable}
                toolbarCheckable={toolbarCheckable}
                checkAll={checkAll}
                expandAll={expandAll}
                title={title}
                search={search}
            ...
            <Spin spinning={unref(props.loading)}>
