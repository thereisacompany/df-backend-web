...
<script lang="ts">
  ...
  // api
  import { addHistoryCategory, updateCategory } from '/@/api/page/history/historyCategory';

  //data
  import { schemas, seoSchemas, getImages } from '/@/views/historyManagement/historyCategory/data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [
        registerSEOForm,
        { getFieldsValue: getSEOFieldsValue, setFieldsValue: setSEOFieldsValue },
      ] = useForm({
        layout: 'vertical',
        labelWidth: 300,
