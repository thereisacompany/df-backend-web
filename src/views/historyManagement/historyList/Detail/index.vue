      ...
      <PageHeader>
        <template #title>
          <div class="flex justify-between">
            ...
            <div>
              <a-button type="text" class="w-36 mr-3" @click="go('/backend/historyList')">
...
<script lang="ts">
  ...
  import {
    ...
    updateArticle,
    // getArticleGamesList,
  } from '/@/api/page/history/historyList';
  import { getAllCategoryList } from '/@/api/page/history/historyCategory';
      ...
      const getOptions = async () => {
        ...
        if (categorys.code === 200) {
          ...
          step.step1.ref.updateSchema([
            { field: 'category', componentProps: { options: option.categorys } },
          ]);
          step.step2.ref.updateSchema([
