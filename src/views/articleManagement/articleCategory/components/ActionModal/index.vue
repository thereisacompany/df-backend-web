...
<script lang="ts">
  ...
  // api
  import { addCategory, updateCategory } from '/@/api/page/article/articleCategory';

  //data
  import { schemas, seoSchemas, getImages } from '/@/views/articleManagement/articleCategory/data';
