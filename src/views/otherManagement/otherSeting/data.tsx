...
export function tableColumns(handleLoading): BasicColumn[] {
  return [
    ...
    {
      title: t('component.otherManagement.Title'),
      dataIndex: 'name',
      width: 200,
    },
    {
      title: t('component.otherManagement.pronoun'),
      dataIndex: 'code',
      width: 100,
    },
    // {
...
export function schemas(disabled): FormSchema[] {
  return [
    {
      field: 'name',
      label: t('component.otherManagement.Title'),
      component: 'Input',
      required: true,
      componentProps: {
        disabled: disabled,
    ...
    {
      field: 'code',
      label: t('component.otherManagement.pronoun'),
      component: 'Input',
      required: true,
      componentProps: {
        disabled: disabled,
